...
def backup_database(backup_dir='backups'):
    ...
    # Handle sqlite:///instance/workouts.db or sqlite:////absolute/path
    if db_url.startswith('sqlite:///'):
        relative_path = db_url[len('sqlite:///'):]
        # Get the absolute path relative to the app's root
        db_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), relative_path)
    else:
